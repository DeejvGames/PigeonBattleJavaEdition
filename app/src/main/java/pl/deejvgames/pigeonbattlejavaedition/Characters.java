...
public enum Characters {
    ...
    RADIO_PIGEON(R.string.radio_pigeon, 1250, 50, 5, 0, 0, 200, R.drawable.player_radio_pigeon),
    PIGOBOMB(R.string.pigobomb, 1350, 60, 0, 0, 0, 450, R.drawable.player_pigobomb),
    FEATHERED_PIGEON(R.string.feathered_pigeon, 1600, 55, 0, 15, 0, 1400, R.drawable.player_feathered_pigeon),
    MILK_PIGEON(R.string.milk_pigeon, 1250, 70, 0, 10, 0, 800, R.drawable.player_milk_pigeon),
    WHEEL_PIGEON(R.string.wheel_pigeon, 1400, 65, 0, 0, 25, 1000, R.drawable.player_wheel_pigeon),
    NUCLEAR_PIGEON(R.string.nuclear_pigeon, 1450, 90, 10, 0, 0, 1500, R.drawable.player_nuclear_pigeon);
